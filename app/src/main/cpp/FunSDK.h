...
typedef int (*POnMsgResult)(int hSender, UI_HANDLE hWnd, int nId, int nParam1, int nParam2, int nParam3, const char *szParam, const void *pData, int nDataLen, int nSeq);
int Fun_InitMsgCallBack(POnMsgResult pResult);
...
#else
#define MEDIA_EX_PARAM void*pPararm,
#define P_PARAM
#endif
...
typedef enum EUIMSG
{
	...
	//从后台切回app，主链接检测，保活
	EMSG_DEV_MAIN_LINK_KEEP_ALIVE = 5149,
